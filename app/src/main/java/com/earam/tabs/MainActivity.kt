...
class MainActivity : Activity() {
    ...
    private class EditorView(context: Activity) : View(context) {
        ...
        override fun onDraw(c: Canvas) {
            ...
            text.color = 0xFFF4F4F4.toInt(); text.textSize = 22f; text.typeface = Typeface.DEFAULT_BOLD
            ...
            val columns = 8; val colWidth = (gridRight - gridX) / columns
            ...
            drawControl(c, "↓", 20f, h - 68f, pickingMode == PickingMode.MANUAL && selectedStroke == StrokeDirection.DOWN)
            drawControl(c, "↑", 58f, h - 68f, pickingMode == PickingMode.MANUAL && selectedStroke == StrokeDirection.UP)
